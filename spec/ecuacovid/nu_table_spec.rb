...
describe Ecuacovid::Nu::NuTable do
  ...
  let(:table) {
    ...
    options = Ecuacovid::Table.new.construct(records, options)
  ...
  context "Tabulated" do
    ...
    it "formats" do
      expected = Ecuacovid::TableSerializers::Nu.(%w{provincia Jan Apr May Jun Aug Sep Oct}, [
        [["Guayas",0,0,45,0,0,0,0]],
        [["Manabí",0,2,0,19,0,58,0]],
        [["Pichincha",0,0,135,164,739,0,845]]
      ])
  
      options = tabular_table.merge report: tabular_table, headers: [:provincia] 
  ...
  context "Default" do
    ...
    it "formats" do
      expected = Ecuacovid::TableSerializers::Nu.(%w{province total_per_month}, [
        [0,0,45].map {|value| ["Guayas", value]},
        [0,2,19, 58].map {|value| ["Manabí", value]},
        [0,135,164,739,845].map {|value| ["Pichincha", value]}
      ])
