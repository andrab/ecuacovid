...
* `created_at` = La fecha del registro **hasta 21 de Mayo**
...
* `fechas por día` = Todas las fechas por día **hasta 21 de Mayo**
...
* `created_at` = La fecha del registro por día **hasta 15 de Mayo**
