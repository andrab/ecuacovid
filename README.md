...
* `created_at` = La fecha del registro **desde Marzo 13 hasta 27 de Agosto**
...
* `fechas por día` = Todas las fechas por día **desde Marzo 13 hasta 27 de Agosto**
...
* `lat` = Latitud
* `lng` = Longitud
* `created_at` = La fecha del registro **desde Marzo 26 hasta 27 de Agosto**
...
* `lat` = Latitud
* `lng` = Longitud
* `fechas por día` = todas las fechas por día **desde Marzo 26 hasta 27 de Agosto**
...
* `lat` = Latitud
* `lng` = Longitud
* `created_at` = La fecha del registro **desde Enero 1 hasta 26 de Agosto** 
...
* `lat` = Latitud
* `lng` = Longitud
* `created_at` = La fecha del registro por día **desde Enero 1 hasta 26 de Agosto**
...
* `lat` = Latitud
* `lng` = Longitud
* `fechas por día` = todas las fechas por día **desde Enero 1 hasta 26 de Agosto**
