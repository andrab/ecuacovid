...
* `created_at` = La fecha del registro **hasta 7 de Junio**
...
* `fechas por día` = Todas las fechas por día **hasta 7 de Junio**
...
* `lat` = Latitud
* `lng` = Longitud
* `created_at` = La fecha del registro **hasta 6 de Junio** 
...
* `lat` = Latitud
* `lng` = Longitud
* `created_at` = La fecha del registro por día **hasta 6 de Junio**
...
* `lat` = Latitud
* `lng` = Longitud
* `fechas por día` = todas las fechas por día **hasta 6 de Junio**
