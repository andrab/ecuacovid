...
* `created_at` = La fecha del registro **hasta 29 de Mayo**
...
* `fechas por día` = Todas las fechas por día **hasta 29 de Mayo**
...
* `created_at` = La fecha del registro por día **hasta 29 de Mayo**
