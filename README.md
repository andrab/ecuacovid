...
* `created_at` = La fecha del registro **desde Marzo 13 hasta 5 de Julio**
...
* `fechas por día` = Todas las fechas por día **desde Marzo 13 hasta 5 de Julio**
...
* `lat` = Latitud
* `lng` = Longitud
* `created_at` = La fecha del registro **desde Marzo 26 hasta 5 de Julio**
...
* `lat` = Latitud
* `lng` = Longitud
* `fechas por día` = todas las fechas por día **desde Marzo 26 hasta 5 de Julio**
...
* `lat` = Latitud
* `lng` = Longitud
* `created_at` = La fecha del registro **desde Enero 1 hasta 4 de Julio** 
...
* `lat` = Latitud
* `lng` = Longitud
* `created_at` = La fecha del registro por día **desde Enero 1 hasta 4 de Julio**
...
* `lat` = Latitud
* `lng` = Longitud
* `fechas por día` = todas las fechas por día **desde Enero 1 hasta 4 de Julio**
