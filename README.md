...
* `created_at` = La fecha del registro **hasta 3 de Junio**
...
* `fechas por día` = Todas las fechas por día **hasta 3 de Junio**
...
* `lat` = Latitud
* `lng` = Longitud
* `created_at` = La fecha del registro por día **hasta 3 de Junio**
