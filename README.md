...
* `created_at` = La fecha del registro **desde Marzo 13 hasta 8 de Junio**
...
* `fechas por día` = Todas las fechas por día **desde Marzo 13 hasta 8 de Junio**
...
* `lat` = Latitud
* `lng` = Longitud
* `created_at` = La fecha del registro **desde Marzo 26 hasta 8 de Junio**
...
* `lat` = Latitud
* `lng` = Longitud
* `fechas por día` = todas las fechas por día **desde Marzo 26 hasta 8 de Junio**
