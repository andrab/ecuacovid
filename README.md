...
* `created_at` = La fecha del registro **hasta 28 de Mayo**
...
* `fechas por día` = Todas las fechas por día **hasta 28 de Mayo**
...
* `created_at` = La fecha del registro por día **hasta 27 de Mayo**
...
* `lat` = Latitud de cantón
* `lng` = Longitud de cantón
* `fechas por día` = todas las fechas por día **hasta 27 de Mayo**
